					...
					'<div class="tdc_item" id="tdc_@{id}">',
						...
						'<div class="tdc_data" tid="@{id}">',
							'<div class="tdc_info">',
		                   	...
		                   	'<div class="http_param"></div>',
		                   	'<div class="http_header"></div>',
		                '</div>',
...
var tdcItemDataTemplate = [
							'<div class="tdc_name_value_type" dtlId="@{j}">',
								'<span>参数</span>',
								'<input id="@{id}_eleName_@{j}" type="text" name="eleName" value="@{name}" disabled="disabled"/>',
								'<input id="@{id}_eleValue_@{j}" type="text" name="eleValue" style="width:260px" value="@{value}"/>',
								'<input id="@{id}_eleType_@{j}" type="text" name="eleType" class="type" value="@{type}" disabled="disabled"/>',
								'<span>@{desc}</span>',
